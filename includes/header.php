...
<link rel="icon" type="image/png" sizes="16x16" href="../assets/uploads/icon/<?=$web_show['icon']?>">
...
<!------------------------------------ Message start -------------------------------------->
					<li class="nav-item dropdown notification_dropdown">
						...
						<div class="dropdown-menu rounded dropdown-menu-right">
							<div id="DZ_W_TimeLine11Home" class="widget-timeline dz-scroll style-1 p-3 height370 ps ps--active-y">
								<ul class="timeline">
									...
									<li class="<?= ($message['status'] == 0 ? 'bg-light':'') ?>">
										...
										<a class="timeline-panel text-muted" href="../messages/view.php?id=<?= $message['id'] ?>">
							...
							<a class="all-notification" href="../messages/see_messages.php">See all messages <i
...
<!------------------------------------- Review Start -------------------------------------->
							...
							<div id="DZ_W_TimeLine11Home" class="widget-timeline dz-scroll style-1 p-3 height370 ps ps--active-y">
								<ul class="timeline">
									...
									<li class="<?= ($review['status'] == 0 ? 'bg-light':'') ?>">
										<div class="timeline-badge <?= $color[$i]?>"></div>
										<a class="timeline-panel text-muted" href="../reviews/view.php?id=<?= $review['id'] ?>">
					...
					<li class="nav-item dropdown header-profile">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a href="../profile/profile.php?page_name=Dashboard>Profile" class="dropdown-item ai-icon">
							...
							<a href="../messages/see_messages.php" class="dropdown-item ai-icon">
							...
							<a href="../authentication/logout.php" class="dropdown-item ai-icon">
		...
		<ul class="metismenu" id="menu">
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="../admin/admin.php?page_name=Dashboard>Admin">Admin</a></li>
					<li <?= ($after_assoc['role'] == 0 ? '':'hidden') ?>><a href="../authentication/register.php?page_name=Dashboard>Register Admin">Register Admin</a></li>
					<li><a href="../profile/profile.php?page_name=Dashboard>Profile">Profile</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="../skills/skills.php?page_name=Skills>Add Skills">Add skills</a></li>
					<li><a href="../skills/see_skills.php?page_name=Skills>See Skills">See skills</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="../services/services.php?page_name=Service>Add service">Add Service</a></li>
					<li><a href="../services/see_services.php?page_name=Service>See service">See Services</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-controls-3"></i>
				...
				<ul aria-expanded="false">
					<li><a href="../reviews/see_reviews.php?page_name=Reviews>See reviews">See Reviews</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-controls-3"></i>
				...
				<ul aria-expanded="false">
					<li><a href="../messages/see_messages.php?page_name=Messages>See messages">See Messages</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-controls-3"></i>
				...
				<ul aria-expanded="false">
					<li><a href="../portfolios/portfolios.php?page_name=Portfolio/Add Portfolio">Add Portfolio</a></li>
					<li><a href="../portfolios/see_portfolios.php?page_name=Portfolio>See Portfolios">See Portfolios</a></li>
				</ul>
			</li>
			<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="flaticon-381-controls-3"></i>
				...
				<ul aria-expanded="true">
					<li <?= ($after_assoc['role'] == 0 ? '':'hidden') ?>>>
						<a href="../web_info/activitys.php?page_name=Web Info>Activitys">Activitys 
							<small class="text-danger">
								<?php foreach($activity_result as $check){
									if($check['status'] == 0){
										echo 'New!';
					...
					<li><a href="../web_info/update_info.php?page_name=Web Info>Change Info">Change Info</a></li>
					<li><a href="../web_info/update_icon.php?page_name=Web Info>Change Icon">Change Icon</a></li>
					<li><a href="../web_info/update_logo_image.php?page_name=Web Info>Change Logo">Change Logo</a></li>
					<li><a href="../web_info/update_landing_image.php?page_name=Web Info>Change Image">Change Image</a></li>
					<li><a href="../web_info/settings.php?page_name=Web Info>Settings">Settings</a></li>
				</ul>
			</li>
		</ul>
