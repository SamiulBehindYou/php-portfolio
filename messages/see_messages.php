...
<div class="row">
    ...
    <small><b>Note:</b> Latest review will show on top.</small>
    <table class="table table-boarderd text-center">
        ...
        <tr class="bg-<?= ($show['status'] == 1 ? '':'black text-white') ?>">
            ...
            <th>
                ...
                <a title="Delete only show when review deactivted." href="message_delete.php?id=<?= $show['id'] ?>" class="btn btn-outline-danger btn-xxs">Delete</a>
            </th>
        </tr>
        </a>
